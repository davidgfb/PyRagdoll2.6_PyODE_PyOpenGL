...
float LENGTH = 0.7, WIDTH = 0.5, HEIGHT = 0.2, RADIUS = 0.18, STARTZ = 0.5, CMASS = 1, WMASS = 0.2; // some constants
...
static dJointID joint[3]; // array3d de dJointIDs //4 juntas de ruedas
...
bool estaEchadoFrenoMano = false;
...
static void command (int cmd) {  // lower 
	...
	////////////// freno ///////////////////
	/*		
	if (cmd == 's' || cmd == 'S') { //freno NO marcha atras
	...
	*/
	...
	//////// freno de mano /////////////
	if (cmd == ' ') { 
		estaEchadoFrenoMano = not estaEchadoFrenoMano;
  	}
  	////////////////////////////////////
...
static void simLoop (int pause) { // simulation loop
	...
	/////////////////////////////////////////////////
    	...
    	if (!pause) {
		for (int nRuedaDelantera = 0; nRuedaDelantera < 2; nRuedaDelantera++) {
...
int main (int argc, char **argv) {
  	...
  	for (i = 0; i < 3; i++) {   	// front and back wheel hinges //traccion trasera?
